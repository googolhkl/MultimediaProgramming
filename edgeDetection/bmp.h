...
class BMP 
{
    public:
        ...
        bool MakeTempFilter(int i, int j);
        double **FillTempFilter(int i, int j);
        BYTE CalcFilter(void);
        bool ConvolutionFilter(const char *filename,int y, int x);
        double ScanFraction();
        bool MakeCZP(int size);
        bool MedianFilter(const char *filename,int y, int x);
        bool MakeSortedArray(int y, int x);
        bool FillSortedArray(int y, int x);
        bool SortArray(int xy);
